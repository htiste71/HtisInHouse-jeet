...
class HomeFragmentWFMS : BaseFragment(), OnMapReadyCallback, View.OnClickListener, MyInterface {
    ...
    lateinit var bottomSheetFragment: SheetDialogFragment
    lateinit var v: View;
    ...
    override fun onMapReady(maps: GoogleMap) {
        ...
        try {
            ...
            if (taskAL.size > 0) {
                for (i in 0 until taskAL.size) {
                    val model = taskAL.get(i)
...
//                jsonObject.put("EndTime", mToTimeAddTask)
    ...
    fun hitAPI(type: Int, params: String) {
        ...
        } else if (type == MY_TASK_LIST_WFMS) {
    ...
    override fun onResume() {
        ...
        hitAPI(ConstantsWFMS.MY_TASK_LIST_WFMS, json.toString())
    }
