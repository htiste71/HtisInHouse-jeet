...
class PerformActivityNew : AppCompatActivity(), MyInterface, View.OnClickListener, iActivity {
...
//    }
    ...
    fun hitAPI(params: String?, TYPE: Int) {
        if (TYPE == ConstantsWFMS.START_TASK_WFMS) {
            ...
            if (status.equals("Pending")) {
                ApiData.forTaskImage(fileToUpload, params, NEW_TASK_STATUS_WFMS, this, this, true)
                ...
                if (value == 0)
                    ...
                    ApiData.forTaskImage(fileToUpload, params, NEW_TASK_STATUS_WFMS, this, this, false)
