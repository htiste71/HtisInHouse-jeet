...
class TeamAdapterWFMS(private val mContext: FragmentActivity?, val myTeamList: ArrayList<MyTeamModel>) : RecyclerView.Adapter<TeamAdapterWFMS.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        holder.bind(mContext, myTeamList.get(position))
    }

    class MyHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(mContext: FragmentActivity?, model: MyTeamModel) {
